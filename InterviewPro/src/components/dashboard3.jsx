      ...
      <div class="space-y-6">
        ...
        <div>
          <h1 class="mb-4 p-4 text-xl font-semibold text-black-800 bg-[#F2F2F7] capitalize dark:text-black-800">
            Requests | <span class="text-gray-500"><Link to="/dashboard4" className="hover:text-black">Current</Link> | <Link to="/dashboard5" className="hover:text-black">Completed</Link></span>
          </h1>
        </div>
      </div>
      <section class="">
                    ...
                    <tr>
                      ...
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <td class="py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                          <button class="px-12 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#191064] rounded-full hover:bg-gray-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                            Start
                          </button>
                        </td>
                      </td>
