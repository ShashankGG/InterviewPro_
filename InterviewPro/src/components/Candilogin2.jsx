      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <h2 className="mt-0 mb-[1rem] text-2xl font-bold text-[#09005F] sm:text-3xl md:text-4xl">
            ...
            <div className="flex justify-between ">
              <a
                href="#"
                className="flex items-center justify-center mt-4 mr-5 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text--200 hover:bg-white-500 dark:hover:bg-blue-600"
              >
              ...
              <a
                href="#"
                className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600"
              >
                <div className="px-4 py-2">
                  <img
                    className="w-6 h-6"
