...
function Signup2(){
  ...
  const handleLogin = async (event) => {
      ...
      const data = {
          ...
          password: formData.get('password_confirmation')  // Ensure this matches your input 'name' attribute
      };
      ...
      try {
        ...
        localStorage.setItem("organisation_email", jsonData.organisation_email);
        localStorage.setItem("organisation_contact", jsonData.organisation_contact);
