                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-black-800">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-300 dark:bg-white-900">
                    ...
                    <tr>
                      ...
                      <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                        <div class="inline-flex items-center px-3 py-1 gap-x-2">
                          <h2 class="text-sm font-normal text-black-800">
                            Back End
                          </h2>
                        </div>
                      </td>
                      <td class="font-bold px-4 py-4 text-sm text-gray-500 dark:text-black-800 whitespace-nowrap">
                        Pair Programming
                      </td>
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <div>
                      ...
                      <td class="px-4 py-4 text-sm text-gray-500 dark:text-black-800 whitespace-nowrap">
                        1 hr
                      </td>
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <td class="py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
