  ...
  return (
    <>
      ...
      <div class="space-y-6">
        ...
        <div>
          <h1 class="mb-4 p-4 text-xl font-semibold text-gray-400 bg-[#F2F2F7] capitalize dark:text-gray-400">
          <Link to="/dashboard3" className="hover:text-black">Requests{" "}</Link>
            | <Link to="/dashboard4" className="hover:text-black">Current{" "}</Link>
            <span class="text-black dark:text-black-500">| Completed</span>
          </h1>
        </div>
      </div>
      <section class="">
              ...
              <div class="overflow-hidden">
                <table class="min-w-full divide-y divide-gray-300 dark:divide-black-800">
                  <thead class="bg-white-50 dark:bg-white-800">
                    ...
                    <th
                        scope="col"
                        class="pl-20 px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400"
                      >
                        Name
                      </th>
                      <th
                  ...
                  <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-300 dark:bg-white-900">
                    <tr>
                      <td class="pl-20 font-bold px-4 py-4 text-sm text-black-500 dark:text-black-800 whitespace-nowrap">
                        Ms. Lavanya Anand
                      </td>
                      <td class="px-4 py-4 text-sm font-medium text-black-700 whitespace-nowrap">
                        <div class="inline-flex items-center gap-x-3">
                          <div class="flex items-center gap-x-2">
                            <FcGoogle class="object-cover w-10 h-10 rounded-full" />
                            <div>
                    ...
                    <tr>
                      ...
                      <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                        <div class="inline-flex items-center gap-x-3">
                          <div class="flex items-center gap-x-2">
                            <SiSap class="object-cover w-10 h-10" />
                            <div>
                      ...
                      <td class="font-bold px-4 py-4 text-sm text-orange-500 dark:text-orange-400 whitespace-nowrap">
                        Medium
                      </td>
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <div>
                      ...
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <button class="px-12 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#2FD14E] rounded-full hover:bg-gray-500 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                          Receive Payment
                        </button>
                      </td>
                    </tr>
                    ...
                    <td class="pl-20 font-bold px-4 py-4 text-sm text-black-500 dark:text-black-800 whitespace-nowrap">
                      ...
                      <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                        <div class="inline-flex items-center gap-x-3">
                          <div class="flex items-center gap-x-2">
                            <SiAccenture class="object-cover w-10 h-10" />
                            <div>
                              <h2 class="font-bold text-gray-800 dark:text-black">
                                Accenture
                              </h2>
                      ...
                      <td class="font-bold px-4 py-4 text-sm text-green-500 dark:text-green-600 whitespace-nowrap">
                        Easy
                      </td>
                      <td class="px-4 py-4 text-sm whitespace-nowrap">
                        <div>
